...
@Module({
  imports:  [ MongooseModule.forFeature([{name: Community.name, schema:CommunitySchema }, {name: User.name, schema: userSchema},{ name: ConversationPubSub.name, schema: ConversationPubSubSchema }
